...
struct TodayView: View {
    ...
    var body: some View {
                ...
                NavigationStack(path: $router.path) {
                    ...
                    .toolbar {
                        ToolbarItem(placement: .topBarTrailing) {
                            NavigationLink {
                                ProfileView(viewModel: ProfileViewModel(pinService: PinService(), userService: UserService(), footprintService: FootprintService(), userDefaultService: UserDefaultService(), treeService: ScannedTreeService()))
                            } label: {
        ...
        .task {
            await viewModel.fetchInformation()
